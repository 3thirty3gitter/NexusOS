...
// Added metadata for sorting
export const HEADER_OPTIONS = [
  { id: 'pilot', name: 'Pilot', description: 'SaaS Command Center', date: '2024-11-24', popularity: 88 },
  { id: 'canvas', name: 'Canvas', description: 'Minimalist & Clean', date: '2024-01-01', popularity: 95 },
  { id: 'nebula', name: 'Nebula', description: 'Glassmorphic Floating UI', date: '2024-03-15', popularity: 92 },
  { id: 'bunker', name: 'Bunker', description: 'Brutalist High-Contrast', date: '2024-06-20', popularity: 85 },
  { id: 'orbit', name: 'Orbit', description: 'Dynamic Interaction', date: '2024-08-01', popularity: 78 },
  { id: 'protocol', name: 'Protocol', description: 'Cyberpunk System', date: '2024-09-10', popularity: 65 },
  { id: 'horizon', name: 'Horizon', description: 'Editorial Double-Decker', date: '2024-02-14', popularity: 70 },
  { id: 'studio', name: 'Studio', description: 'Left Sidebar Nav', date: '2024-01-20', popularity: 60 },
  { id: 'terminal', name: 'Terminal', description: 'Dev/Code Aesthetic', date: '2024-04-01', popularity: 55 },
  { id: 'portfolio', name: 'Portfolio', description: 'Split Screen Bold', date: '2024-05-05', popularity: 72 },
  { id: 'venture', name: 'Venture', description: 'Search Utility First', date: '2024-02-01', popularity: 80 },
  { id: 'metro', name: 'Metro', description: 'Tile Grid System', date: '2024-10-01', popularity: 68 },
  { id: 'modul', name: 'Modul', description: 'Swiss Grid Style', date: '2024-10-05', popularity: 74 },
  { id: 'luxe', name: 'Luxe', description: 'High-End Serif', date: '2024-07-01', popularity: 90 },
  { id: 'gullwing', name: 'Gullwing', description: 'Symmetrical Split', date: '2024-07-15', popularity: 77 },
  { id: 'pop', name: 'Pop', description: 'Neo-Brutalist Soft', date: '2024-09-01', popularity: 82 },
  { id: 'stark', name: 'Stark', description: 'Ultra High Contrast', date: '2024-08-20', popularity: 66 },
  { id: 'offset', name: 'Offset', description: 'Asymmetrical Layout', date: '2024-03-01', popularity: 58 },
  { id: 'ticker', name: 'Ticker', description: 'Data Stream Header', date: '2024-06-01', popularity: 50 },
